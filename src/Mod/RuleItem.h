...
private:
	...
	bool _recover, _recoverCorpse, _ignoreInBaseDefense, _ignoreInCraftEquip, _liveAlien, _canBeSoldNormally, _canBeTransferredNormally;
...
public:
	...
	/// Checks if this item can be transferred to other base via transfer menu.
