...
void ConfirmDestinationState::btnTransferClick(Action *)
{
	...
	if ((targetBase->getFreeCraftSlots(_crafts.front()->getRules()->getRequiresCraftSlotFunc())) <= 0) // don't know how you'd get less than 0 available hangars, but want to handle that just in case
	{
